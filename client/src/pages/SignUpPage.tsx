      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#716D65] mt-2">
            Join the circle of thoughtful readers.
          </p>
        </div>
        ...
        <div className="bg-[#F8F7F3] border border-[#DDD9D0] rounded-xl p-8 sm:p-10 text-center">
          ...
          <p className="text-xs text-[#716D65] mb-8">
            Connect with Google to personalize your publication feed with topics tailored to your interests.
          </p>
          ...
          <p className="mt-8 text-[11px] text-[#8A867E] leading-relaxed">
            By signing up, you agree to our Terms of Service and Privacy Policy. Authentication is securely handled via Google OAuth 2.0.
          </p>
        </div>
      </div>
    </div>
