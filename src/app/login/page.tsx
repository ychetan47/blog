    ...
    <div className="w-full min-h-[calc(100vh-140px)] flex flex-col items-center justify-center px-6 py-16 sm:py-24 bg-[#F8F7F3]">
      ...
      <div className="text-center max-w-md mx-auto mb-10">
        ...
        <p className="text-base text-[#716D65] mt-4 font-normal">
          Keep your saved stories with you, on any device.
        </p>
      </div>

      {/* Form Container: Warm background (#F3F1EB), thin border (#DDD9D0), no shadow, 8-12px radius */}
      <div className="w-full max-w-md bg-[#F3F1EB] rounded-[10px] border border-[#DDD9D0] p-8 sm:p-10">
        ...
        {/* Links row */}
        <div className="flex items-center justify-between mt-8 pt-4 border-t border-[#DDD9D0] text-xs text-[#716D65]">
          <Link
            href="/signup"
